...
export default async function Home({ params }) {
	...
	return (
		<div className="w-[65rem] mobile:w-full">
			<div className="mx-2 my-4 font-bold dark:text-Grey-900 text-p1 mobile:my-2">
			...
			<TrendingProductViewer
				...
				error={error}
			/>
			<div className="grid grid-cols-2 gap-x-8 mt-8 mx-2 mobile:grid-cols-1 mobile:mx-0 mobile:gap-y-4">
				<div className="bg-white">
					<div className="border-l-4 border-l-Green-600 m-2">
						<div className="px-4 font-semibold">{t.homepage.eventVideo}</div>
					</div>
					<div className="m-4 flex flex-col justify-center items-center mobile:mx-0">
