...
export default async function Home({ params }) {
	...
	return (
		<div className="w-[65rem] mobile:w-full">
			...
			/>
			<div className="grid grid-cols-2 gap-x-8 mt-8 mx-2 mobile:grid-cols-1 mobile:w-full mobile:mx-0">
				<div className="bg-white">
					<div className="border-l-4 border-l-Green-600 m-2">
						<div className="px-4 font-semibold">{t.homepage.eventVideo}</div>
					</div>
					<div className="m-4 flex flex-col justify-center items-center mobile:m-2">
						<VideoPlayer videoId="5XDNHx2MQ40" />
					</div>
				</div>
				<div className="grid grid-rows-[11rem_auto] gap-4">
					<div className="bg-white mobile:mt-4">
						<div className="border-l-4 border-l-Green-600 m-2">
